 ...
 * Generated at: 2016-05-06 01:30:06 UTC
...
if(status!=null)
{
      ...
      out.write("\tborder-color:#112EA1;\r\n");
      out.write("}\r\n");
      out.write("</style>\r\n");
      out.write("<script language=\"javascript\">\r\n");
      out.write("\tfunction check()\r\n");
      out.write("\t{\r\n");
      out.write("\t\tif(document.f1.app_name.value.length==0 || document.f1.desc.value.length==0 || document.f1.app_image.value.length==0)\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\twindow.location.href = 'applications.jsp?no=1&no1=10';\r\n");
      ...
      out.write("\t\tif(document.f1.app_name.value.length==0 || document.f1.desc.value.length==0 || document.f1.app_image.value.length==0)\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\twindow.location.href = 'applications.jsp?no=3&no1=10';\r\n");
      out.write("\t\t\treturn false;      \r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
...
if(no==1)
{
	ResultSet rs3=Serv_Configuration.Servers();
      ...
      out.print(request.getContextPath() );
      out.write("/AddApplication\" enctype=\"multipart/form-data\" >\r\n");
      out.write("\t<table  border=\"2\" cellpadding=\"5\" cellspacing=\"10\" align=\"center\">\r\n");
      out.write("\t\t<tr bgcolor=\"#D2FE48\" bordercolor=\"blue\" width=\"10\">\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Application Name</th>\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Server Name</th>\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Application Image</th>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t<tr bgcolor=\"white\">\r\n");
      out.write("\t\t\t<td><input type=\"text\" name=\"app_name\" size=\"20\"></td>\r\n");
      out.write("\t\t\t<td><select name=\"serv_no\" size=\"1\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t</select></td>\t\r\n");
      out.write("\t\t\t<td><input type=\"file\" name=\"app_image\" size=\"20\"></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t<br></br>\r\n");
      out.write("\t  <center><input type=\"submit\" value=\"Add Application\" name=\"Add_App\" onclick=\"return check();\"></input></center>\r\n");
      out.write("\t  </form>\r\n");
      out.write("\r\n");
      out.write("\t  </div>\r\n");
...
if(request.getAttribute(Global.ADMIN_LOGIN_STATUS) != null){
	if(request.getAttribute(Global.ADMIN_LOGIN_STATUS).toString().equals(Global.ADMIN_INVALID_MESSAGE)){
      ...
      out.write("\r\n");
      out.write("\t<font color=\"red\" size=\"3\"><b>Error oucrred while adding application </b></font>\r\n");
...
ResultSet rs2=Serv_Configuration.config();
      ...
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t<tr bgcolor=\"white\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"app_no\" value=\"");
      out.print(app_no);
      out.write("\" size=\"10\">\r\n");
      out.write("\t\t\t<td><input type=\"text\" name=\"app_name\" value=\"");
      out.print(app_name);
      ...
      out.write("\r\n");
      out.write("\t\t\t</select></td>\t\r\n");
      out.write("\t\t\t<td><input type=\"file\" name=\"app_image\" value=\"");
      out.print(app_image);
      out.write("\" size=\"20\"></td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t<br></br>\r\n");
      out.write("\t  <center><input type=\"submit\" value=\"Update Application\" onclick=\"return check1();\"></input></center>\r\n");
      out.write("\t  </form>\r\n");
      out.write("\t  </div>\r\n");
...
if(request.getAttribute(Global.ADMIN_LOGIN_STATUS) != null){
	if(request.getAttribute(Global.ADMIN_LOGIN_STATUS).toString().equals(Global.ADMIN_INVALID_MESSAGEE)){
      ...
      out.write("\r\n");
      out.write("\t<font color=\"red\" size=\"3\"><b>Error occered while updating application </b></font>\r\n");
...
else
{
      ...
      out.write("     <div class=\"feat_left\">\r\n");
      out.write("\t<table  border=\"2\"  cellpadding=\"5\" cellspacing=\"10\" align=\"center\">\r\n");
      out.write("\t\t<tr bgcolor=\"#D2FE48\" id=\"div1\" >\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Application No</th>\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Application Name</th>\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Server Name</th>\r\n");
      out.write("\t\t\t<th rowspan=\"1\">Application Image</th>\r\n");
	...
	while(rs.next())
	{
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(Serv_Configuration.getName(rs.getInt(3)));
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      ...
      out.print(request.getContextPath() );
      out.write("/JSP/applications.jsp?no=2&a_no=");
      out.print(rs.getInt(1));
      out.write("&app_name=");
      out.print(rs.getString(2));
      out.write("&serv_no=");
      ...
      out.write("\t\t\t<td bgcolor=\"white\"><a href=\"");
      out.print(request.getContextPath() );
      out.write("/DeleteApplication?a_no=");
      out.print(rs.getInt(1) );
      out.write("\"><img src=\"");
      out.print(request.getContextPath() );
      ...
      out.write("\r\n");
      out.write("\t</table>\r\n");
      out.write("\t<center style=\"padding-top: 20px;\"><input type=\"button\"  value=\"Add Application\" onclick=\"window.location.href='");
      out.print(request.getContextPath() );
      out.write("/JSP/applications.jsp?no=1'\" ></input></center>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t</div>\r\n");
...
if(no1==10)
{
      ...
      out.write("\t<th rowspan=\"2\"><pre>OOP'S......! You haven't filled up all the fields.....</pre></th>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t</table>\r\n");
}
      out.write('\r');
...
if(no1==11)
{
      ...
      out.write("<table border=\"0\" width=\"45%\" cellpadding=\"5\" cellspacing=\"10\" align=\"center\">\r\n");
      out.write("\t<tr bgcolor=\"#9CBA7F\">\r\n");
      out.write("\t<th rowspan=\"2\"><pre>Successfully Added new application.....</pre></th>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t</table>\r\n");
}
      out.write('\r');
...
if(no1==12)
{
      ...
      out.write("<table border=\"0\" width=\"45%\" cellpadding=\"5\" cellspacing=\"10\" align=\"center\">\r\n");
      out.write("\t<tr bgcolor=\"#9CBA7F\">\r\n");
      out.write("\t<th rowspan=\"2\"><pre>Successfully updated the application.....</pre></th>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t</table>\r\n");
}
      out.write('\r');
...
if(no1==13)
{
      ...
      out.write("<table border=\"0\" width=\"45%\" cellpadding=\"5\" cellspacing=\"10\" align=\"center\">\r\n");
      out.write("\t<tr bgcolor=\"#9CBA7F\">\r\n");
      out.write("\t<th rowspan=\"2\"><pre><font color=\"red\">Successfully deleted the application.....</font></pre></th>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t</table>\r\n");
}
      out.write("\r\n");
